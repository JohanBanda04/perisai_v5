                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <form action="{{ route('konfig.konfiglaporanberita') }}" method="get"
                                        ...
                                        @foreach($konfig as $id=>$dt)
                                           ...
                                           margin: 0 auto; overflow-x: auto; white-space: nowrap;">
                                                    <div class="btn-group">
                                                        ...
                                                        <form action="{{ route('konfig.deletekonfig',$dt->id_konfig) }}"
                                                              method="post"
        ...
        <div class="modal-dialog modal-dialog-centered" style="width: 1000px;" role="document">
            <div class="modal-content" style="">
                ...
                <div class="modal-body " style="">
                    <form action="{{ route('konfig.storekonfig') }}" method="post" id="frmBeritaSatkerKonfig"
    ...
    <script>
        $(function () {
            ...
            $('.tampilkandetailkonfig').click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route('konfig.tampilkandetailkonfig') }}',
                    cache: false,
                    data: {
                        _token: "{{ csrf_token() }}",
                        id_konfig: id_konfig,
