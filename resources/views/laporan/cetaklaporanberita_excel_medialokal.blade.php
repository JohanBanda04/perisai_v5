    ...
    <table class="tabelpresensi">
        ...
        $bulan = $exp_tgl_input[1];
            ...
            <tr class="tdcolor">
                ...
                <td colspan="10" align="center" valign="center" style="font-weight: bold; font-size: 15px; background: #eceaea">
                    @php
                        $jml_ml = 0;
                    @endphp
                    @foreach($links_media_lokal as $ml)
                        @if(strlen($ml)>10)
                            @php
                                $jml_ml +=1;
                            @endphp
