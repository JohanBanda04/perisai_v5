        ...
        $(add_button_edit).click(function (e) {
            ...
            if (x < max_fields) { //max input box allowed
                ...
                $(wrapper_edit).append('<div>' +
                    ...
                    '</td>' +
                    '<td style=""><input required type="text" name="jumlah_edit[]" id=jumlah_edit[] class="form-control"  placeholder="Link Media Lokal" >' +
                    '</td>' +
                    '</tr>' +
                    '</table>' +
        ...
        $(add_button_edit_nasional).click(function (e) {
            ...
            if (x_nasional < max_fields) { //max input box allowed
                ...
                $(wrapper_edit_nasional).append('<div>' +
                    ...
                    '</td>' +
                    '<td style=""><input required type="text" name="jumlah_edit_nasional[]" class="form-control"  placeholder="Link Media Nasional" >' +
                    '</td>' +
                    '</tr>' +
                    '</table>' +
